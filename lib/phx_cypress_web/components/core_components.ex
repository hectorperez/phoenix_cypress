defmodule PhxCypressWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxCypressWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxCypressWeb.Gettext, "errors", msg, opts)
    end
  end
